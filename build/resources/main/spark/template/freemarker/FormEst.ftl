...
<html lang="es">
    <head>
        ...
        <title><#if (estudiante.matricula)?? && !(agregar)??>Editar<#else>Registrar</#if> Estudiante</title>
    </head>
    <body>
        ...
        <div class="container" style="margin-top: 15px;">
            <div class="card">
                <div class="card-header">
                    <h3><#if (estudiante.matricula)?? && !(agregar)??>Editar<#else>Registrar</#if> Estudiante</h3>
                </div>
                <div class="card-body">
                    ...
                    <form action="/<#if (estudiante.matricula)?? && !(agregar)??>editarEst/${estudiante.matricula?string["0"]}<#else>agregarEst</#if>" method="post">
                        <div class="form-group">
                            <label for="matricula">Matr&iacute;cula:</label>
                            <input type="text" class="form-control" name="matricula" id="matricula" placeholder="Matr&iacute;cula" value="<#if (estudiante.matricula)??>${estudiante.matricula?string["0"]}</#if>" maxlength="8" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="telefono" id="telefono" placeholder="Tel&eacute;fono" value="<#if (estudiante.telefono)??>${estudiante.telefono}</#if>" maxlength="10" required>
                        </div>
